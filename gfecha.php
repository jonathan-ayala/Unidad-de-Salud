...
<script>
	...
	$i="";
	$comando3 = "SELECT tag.*, expediente.* from tag, expediente where tag.cod_expediente= expediente.cod_expediente and tag.estado_embarazada='1' and tag.fecha  BETWEEN '$fechai' and '$fechaf' ";
