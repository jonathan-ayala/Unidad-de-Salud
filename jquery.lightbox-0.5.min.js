...
(function($){$.fn.lightBox=function(settings){
	settings=jQuery.extend({overlayBgColor:'#000',overlayOpacity:0.8,fixedNavigation:false,imageLoading:'galeria/lightbox-ico-loading.gif',imageBtnPrev:'galeria/lightbox-btn-prev.gif',imageBtnNext:'galeria/lightbox-btn-next.gif',imageBtnClose:'galeria/lightbox-btn-close.gif',imageBlank:'galeria/lightbox-blank.gif',containerBorderSize:10,containerResizeSpeed:400,txtImage:'Image',txtOf:'of',keyToClose:'c',keyToPrev:'p',keyToNext:'n',imageArray:[],activeImage:0},settings);
...
function _set_interface(){
	...
	$('#jquery-overlay').css({width:arrPageSizes[0],height:arrPageSizes[1]});var arrPageScroll=___getPageScroll();
