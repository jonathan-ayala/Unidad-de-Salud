...
<script>
	...
	<h1 style='font-size:16px; font-weight:bold;border-bottom:black 1px solid; text-align:center'>Reportes de embarazadas <br>desde: $fechai, hasta: $fechaf 
	<table align='center' width='972px' border=1 style='border-collapse:collapse'>
	<tr>
	<td align='center' class='txt' width='10px'>Nº
	<td align='center' class='txt' width='150px'>Duración
	...
	$i="";
	$comando3 = "SELECT tag.*, expediente.* from tag, expediente where tag.cod_expediente= expediente.cod_expediente and tag.estado_embarazada='3' and tag.fecha  BETWEEN '$fechai' and '$fechaf' ";
	...
	<tr>
		...
		<td align='center'  width='150px'>$meses semana(s)
