...
setTimeout("window.location='reporte.dotores.php?perquin=" + dato_url + "'", num_aleatorio * 1000)
...
echo "<html>
        ...
        <body>
            <table align=center style='width:800px;'>
                ...
                <tr>
                    <td colspan=2 align=center><h3>REPORTE DE DOCTORES<b></b></td>
                </tr>
             </table>";              
...
$id_usuario=$aDatos["nombre_doctor"];
$nombre=$aDatos["apellido_doctor"];
...
echo" </table>
<table align='center'
<tr><td><h3>Usuario:$nombre $apellido<br></td>
    </h3>
</tr>
";
